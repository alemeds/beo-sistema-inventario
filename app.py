...
class AuthenticationManager:
        ...
        try:
            self.users = {
                ...
                st.secrets.users.hospitalario_user: {
                    ...
                    "permissions": ["read", "write", "logias", "hermanos"]  # Solo puede escribir en logias y hermanos
                },
                ...
                st.secrets.users.maestro_user: {
                    ...
                    "permissions": ["read"]  # Solo lectura de todo
                }
            }
    ...
    def get_available_sections(self):
        ...
        # Maestro: solo lectura, pero puede ver todo
        # (las funciones internamente controlarán que solo sea lectura)
...
def gestionar_hermanos():
    ...
    # Resto de tabs (editar e historial) - similar implementación con controles de permisos
...
def gestionar_elementos():
    ...
    # Código completo de gestión de elementos...
...
def gestionar_prestamos():
    ...
    # Código completo de gestión de préstamos...
    st.markdown("### 📋 Módulo en desarrollo con permisos de administrador")
...
def gestionar_depositos():
    ...
    # Código completo de gestión de depósitos...
    st.markdown("### 🏢 Módulo en desarrollo con permisos de administrador")
